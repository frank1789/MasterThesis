...
\begin{figure}[h!]
  ...
  \begin{axis}[width=12cm, height=7cm,  grid=major, grid style={dashed,gray!30},
    xlabel=epoch,  ylabel=loss, legend pos=outer north east, legend cell align=left, smooth]
		...
		\addplot[light-gray	] 	table [x=step, y=val_mrcnn_bbox_loss, col sep=comma] 	{neuralnetworks/scalars.csv};
...
\begin{figure}[h!]
  ...
  \begin{axis}[width=12cm, height=7cm,  grid=major, grid style={dashed,gray!30},
    xlabel=epoch,  ylabel=loss, legend pos=outer north east, legend cell align=left, smooth]
		...
		\addlegendentry{{\scriptsize val rpn class loss}}
		\addplot[light-gray	] 	table [x=step, y=val_mrcnn_bbox_loss, col sep=comma] 	{neuralnetworks/scalars100-199.csv};
