...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.75\textwidth]{blender.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.70\textwidth]{annotation.png}
...
\begin{figure}[!h]
    ...
    \captionsource{Thermal image extrated from FLIR dataset.}{\href{https://www.flir.com/oem/adas/adas-dataset-form/}{https://www.flir.com}}
    \label{fig:th-image}
\end{figure}