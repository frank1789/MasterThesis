...
\begin{figure}[htb]
    \centering
    \resizebox{0.8\textwidth}{!}{\input{thermalcamera/application.tex}}
...
\begin{figure}[b]
    \centering
    \resizebox{0.80\textwidth}{!}{\input{thermalcamera/ffcstates.tex}}
    \caption{FFC States.}
...
\begin{figure}[!h]
    \centering
    \resizebox{0.80\textwidth}{!}{\input{thermalcamera/histogram.tex}}
