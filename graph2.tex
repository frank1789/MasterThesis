...
\begin{axis}[width=19cm, height=12cm,grid=major, grid style={dashed,gray!30},
    xlabel=epoch,  ylabel=loss, legend pos=outer north east, legend cell align=left, smooth, axis background/.style={fill=black}, legend style={fill=none,draw=white}, ymax=1.5, xmax=200, ymin=0, xmin=100, every axis plot/.append style={line width=1.85pt}]
		\addplot[red] 			table [x=step, y=val_loss, col sep=comma] 				{neuralnetworks/scalars100-199.csv};
		\addlegendentry[color=white]{{\scriptsize val.}}
		\addplot[babyblueeyes] 	table [x=step, y=mrcnn_class_loss, col sep=comma] 		{neuralnetworks/scalars100-199.csv};
		\addlegendentry[color=white]{{\scriptsize mclass loss}}
		\addplot[amber] 		table [x=step, y=val_rpn_bbox_loss, col sep=comma] 		{neuralnetworks/scalars100-199.csv};
		\addlegendentry[color=white]{{\scriptsize rpn boundin box loss}}
		...
		\addplot[orange] 		table [x=step, y=rpn_bbox_loss, col sep=comma] 			{neuralnetworks/scalars100-199.csv};
		\addlegendentry[color=white]{{\scriptsize rpn boundig box loss}}
		...
		\addlegendentry[color=white]{{\scriptsize val bounding box loss}}
