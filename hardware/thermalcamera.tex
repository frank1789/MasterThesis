...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.65\textwidth]{lepton_architecture.png}
...
\begin{figure}[!h]
    \centering
    \resizebox{0.65\textwidth}{!}{\input{hardware/blockdiagram.tex}}
...
\item \textbf{SPI} for transferring video frames from the camera to a SPI master device.
\item \textbf{I$^2$C} for receiving control commands from the I$^2$C master device.
\end{itemize}
